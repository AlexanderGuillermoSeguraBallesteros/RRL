...
from CoreFunctions_v4 import ObjectiveFunction
from CoreFunctions_v4 import GradientFunctionM
from CoreFunctions_v4 import  train
from CoreFunctions_v4 import ComputeF
from CoreFunctions_v4 import RewardFunction
from CoreFunctions_v4 import SharpeRatio
...
#theta = fmin_ncg(ObjectiveFunction, theta, GradientFunctionM, args=(X, Xn, T, M, mu, transactionCosts, startPos), avextol=1e-8, maxiter=50)
theta = train(theta, X, Xn, T, M, mu, transactionCosts, startPos, 0.9, 1000)
